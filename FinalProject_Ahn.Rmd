...
Walking through the U of M campus, it's not difficult to observe the stark contrast between the architecture of Michigan's newer buildings like the Ross building (completed in 2009) lying across from the more traditional buildings making up Michigan's Law Quad (completed in 1933). This difference in style and structure of these two buildings demonstrates the underlying improvements/changes in labor, material, production, and new technology experienced by the construction industry. Whether these technological advancements have been driven by the need for efficiency, specific designs, durability, or availability of different materials, this project seeks to investigate how the construction materials used for wall and roof of buildings across US have changed throughout the years. 
...
To investigate the relationship between the construction materials and the construction year and whether certain materials are preferred for smaller vs. larger buildings, descriptive statistics, specifically the mean percentage, was calculated to estimate the proportion of different wall and roof construction material by construction year and square footage. The square footage categories provided by the dataset was further collapsed into 3 levels for better chance of meaningful distinction between the groups:
